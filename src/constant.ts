...
export const SHOPPE_STORE_NEXT_PAGE_BTN =
  '.shopee-page-controller > button.shopee-icon-button.shopee-icon-button--right'
export const SHOPPE_STORE_PAGE_CONTROLLER = '.shopee-page-controller'
